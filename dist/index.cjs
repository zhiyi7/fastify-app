    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
              ...
              serializers: {
                ...
                req: function req(_req) {
                  return {
                    ...
                    headers: configCopy.app.disableLogRequestHeaders ? null : _req.headers
                  };
                }
              }
            }, loggerConfig),
           ...
           ************************************/
          if (!((_config$app2 = config.app) !== null && _config$app2 !== void 0 && _config$app2.disableLogRequestBody)) {
           ...
           ***********************************/
          if (!(config !== null && config !== void 0 && (_config$app3 = config.app) !== null && _config$app3 !== void 0 && _config$app3.disableSendRequestIdHeader)) {
           ...
           * **********************************/
          if (!(config !== null && config !== void 0 && (_config$app4 = config.app) !== null && _config$app4 !== void 0 && _config$app4.disableApiErrorHandler)) {
            fastifyInstance.setErrorHandler(function (error, req, res) {
              if (error instanceof ApiError) {
                ...
                res.status((config === null || config === void 0 || (_config$app5 = config.app) === null || _config$app5 === void 0 ? void 0 : _config$app5.internalServerErrorCode) || 200).send(err);
              }
            });
            if (!(config !== null && config !== void 0 && (_config$app6 = config.app) !== null && _config$app6 !== void 0 && _config$app6.disableLogApiError)) {
           ...
           * Health Check Routes
           * **********************************/
          if (!(config !== null && config !== void 0 && (_config$app7 = config.app) !== null && _config$app7 !== void 0 && _config$app7.disableHealthCheckRoutes)) {
            rev = 'unknown';
            if (config !== null && config !== void 0 && (_config$app8 = config.app) !== null && _config$app8 !== void 0 && _config$app8.enableHealthCheckShowsGitRev) {
              try {
            ...
            fastifyInstance.all(((_config$app$healthChe = config === null || config === void 0 || (_config$app9 = config.app) === null || _config$app9 === void 0 ? void 0 : _config$app9.healthCheckRoutesPrefix) !== null && _config$app$healthChe !== void 0 ? _config$app$healthChe : '') + '/ping', /*#__PURE__*/function () {
            ...
            fastifyInstance.all(((_config$app$healthChe2 = config === null || config === void 0 || (_config$app0 = config.app) === null || _config$app0 === void 0 ? void 0 : _config$app0.healthCheckRoutesPrefix) !== null && _config$app$healthChe2 !== void 0 ? _config$app$healthChe2 : '') + '/test-api-error', function (req, res) {
            ...
            fastifyInstance.all(((_config$app$healthChe3 = config === null || config === void 0 || (_config$app1 = config.app) === null || _config$app1 === void 0 ? void 0 : _config$app1.healthCheckRoutesPrefix) !== null && _config$app$healthChe3 !== void 0 ? _config$app$healthChe3 : '') + '/test-uncaught-error', function (req, res) {
           ...
           * **********************************/
          if (!(config !== null && config !== void 0 && (_config$app10 = config.app) !== null && _config$app10 !== void 0 && _config$app10.disableAddRequestState)) {
           ...
           * **********************************/
          if (!(config !== null && config !== void 0 && (_config$app11 = config.app) !== null && _config$app11 !== void 0 && _config$app11.disableReplyHelperFunctions)) {
